# Translation Management System for Academic Research

## Description

A lightweight, research-oriented translation management platform for multilingual research software. It can be used to manage phrases, translations, language metadata, and media assets as structured records, while remaining compatible with existing translation assets and workflows.
...
- Add or remove supported languages with language metadata
- Configure one source language and multiple target languages
- Import Excel and CSV translation files
...
- Add and edit translations with per-language status tracking
